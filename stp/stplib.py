...
# File modified by Filip Holik,
# for supporting of HP switches 3800, KA.15.17.0008, OF 1.3
...
#Normally used STP multicast address from packet.bpdu,
# but HP does not support multicast match -> changed to some random unicast
BRIDGE_GROUP_ADDRESS = 'fa:80:c2:00:00:00'
...
#HP switches support only NO_PACKET_IN, if something else received - error,
# all actions replaced to NO_PACKET_IN only.
# for OpenFlow 1.2
PORT_CONFIG_V1_2 = {PORT_STATE_DISABLE: ofproto_v1_2.OFPPC_NO_PACKET_IN,
                    PORT_STATE_BLOCK: ofproto_v1_2.OFPPC_NO_PACKET_IN,
                    PORT_STATE_LISTEN: ofproto_v1_2.OFPPC_NO_PACKET_IN,
                    PORT_STATE_LEARN: ofproto_v1_2.OFPPC_NO_PACKET_IN,
                    PORT_STATE_FORWARD: 0}

# for OpenFlow 1.3
PORT_CONFIG_V1_3 = {PORT_STATE_DISABLE: ofproto_v1_3.OFPPC_NO_PACKET_IN,
                    PORT_STATE_BLOCK: ofproto_v1_3.OFPPC_NO_PACKET_IN,
...
class Port(object):
    ...
    def _generate_config_bpdu(self, flags):
        ...
        dst_mac = BRIDGE_GROUP_ADDRESS #bpdu.
...
class OfCtl_v1_2later(OfCtl_v1_0):
    ...
    def set_port_status(self, port, state):
        ...
        mask = 0b10000000 #Mask changed from 0b1100101, HP switches does not support setting of anything else.
    ...
    def add_bpdu_pkt_in_flow(self):
        ...
        match = parser.OFPMatch(eth_dst = BRIDGE_GROUP_ADDRESS)
        #match = parser.OFPMatch(eth_type=0x8181)
        actions = [parser.OFPActionOutput(ofp.OFPP_CONTROLLER,
                                          ofp.OFPCML_NO_BUFFER)]
        inst = [parser.OFPInstructionActions(ofp.OFPIT_APPLY_ACTIONS,
                                             actions)]
        #HP switches need table_id = 100
    ...
    def del_no_pkt_in_flow(self, in_port):
        ...
        mod = parser.OFPFlowMod(self.dp, command=ofp.OFPFC_DELETE_STRICT,
                                ...
                                priority=NO_PKT_IN_PRIORITY, match=match, table_id = 100)
        self.dp.send_msg(mod)
